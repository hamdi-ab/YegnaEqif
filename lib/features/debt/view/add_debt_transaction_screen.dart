...
class AddDebtTransactionScreen extends StatefulWidget {
  const AddDebtTransactionScreen({super.key});
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      final newTransaction = Debt(
        ...
        dueDate: _selectedDate ?? DateTime.now().add(const Duration(days: 30)),
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Toggle(
                  onToggle: _updateIncomeExpense, labels: ["Lent", "borrowed"]),
              const SizedBox(height: 20),
